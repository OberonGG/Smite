...
-- ==========================================
-- 4. COMPREHENSIVE DECORATIVE REMOVAL (reduce.lua + test.lua)
-- ==========================================
local DECORATIVE = {
...
-- ==========================================
-- 5. CHARACTER CLEANING (reduce.lua style)
-- ==========================================
    ...
    for _, inst in ipairs(char:GetDescendants()) do
        ...
        elseif inst:IsA("BasePart") then
            if not CORE_LIMBS[inst.Name] then
                inst.Transparency = 1
                inst.LocalTransparencyModifier = 1  -- [OPTIMIZE] Reduce network traffic
            else
...
-- ==========================================
-- 6. LIGHTING OPTIMIZATION (reduce.lua + test.lua)
-- ==========================================
...
-- ==========================================
-- 7. WORLD OPTIMIZATION (reduce.lua + test.lua merged)
-- ==========================================
...
-- ==========================================
-- 8. TERRAIN CLEARING (PING OPTIMIZATION)
-- ==========================================
task.spawn(function()
    pcall(function()
...
-- ==========================================
-- 9. INITIAL WORLD PROCESSING WITH BATCHING (72-HOUR SAFE)
-- ==========================================
local BATCH_SIZE = 30  -- [OPTIMIZED] Increased from 10 to 30 for faster processing
...
-- ==========================================
-- 10. PERMANENT NPC FOLDER DELETION (NEVER COMEBACK)
-- ==========================================
task.spawn(function()
...
-- ==========================================
-- 11. AUTO CLOSE DAILY LOGIN (DEBOUNCED & EVENT-DRIVEN)
-- ==========================================
task.spawn(function()
    local lastClose = 0
